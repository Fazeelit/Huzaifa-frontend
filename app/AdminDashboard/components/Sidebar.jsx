...
export default function Sidebar({ isOpen, toggleSidebar, isCollapsed = false }) {
  ...
  const links = [
    ...
    { name: "Outdoor Supply", icon: Truck, path: "/AdminDashboard/outdoor-supply", moduleKey: "PURCHASE" },
    { name: "Outdoor Supply Report", icon: BarChart3, path: "/AdminDashboard/outdoor-supply-report", moduleKey: "PURCHASE" },
