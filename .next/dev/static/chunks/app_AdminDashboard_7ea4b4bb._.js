...
"[project]/app/AdminDashboard/customers/[id]/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const extractcustomerPaymentsArray = (response)=>Array.isArray(response?.customerpayments) ? response.customerpayments : Array.isArray(response?.data?.customerpayments) ? response.data.customerpayments : Array.isArray(response?.data) ? response.data : Array.isArray(response) ? response : [];
...
const extractpurchasesArray = (response)=>Array.isArray(response?.sales) ? response.sales : Array.isArray(response?.data?.sales) ? response.data.sales : Array.isArray(response?.data?.data) ? response.data.data : Array.isArray(response?.data) ? response.data : Array.isArray(response?.purchases) ? response.purchases : Array.isArray(response) ? response : [];
const extractcustomersArray = (response)=>Array.isArray(response?.data) ? response.data : Array.isArray(response?.customers) ? response.customers : Array.isArray(response?.data?.customers) ? response.data.customers : Array.isArray(response) ? response : [];
...
const getpurchaseUnitPrice = (item = {})=>parseAmount(item?.salePrice ?? item?.price ?? item?.unitPrice ?? item?.purchasePrice ?? item?.retailSalePrice);
const getReturnedpurchaseQuantity = (item = {})=>Math.max(Number(item?.returnedQuantity ?? item?.returnedQty ?? item?.returnQty ?? item?.quantityReturned ?? 0) || 0, 0);
const getChargedpurchaseQuantity = (item = {})=>Math.max(Number(item?.chargedQuantity ?? item?.quantity ?? item?.qty ?? 0) - getReturnedpurchaseQuantity(item), 0);
const getNormalizedpurchaseAmounts = (purchase = {})=>{
    ...
    const derivedSubtotal = items.reduce((sum, item)=>sum + getChargedpurchaseQuantity(item) * getpurchaseUnitPrice(item), 0);
    const derivedTotal = Math.max(Number((derivedSubtotal - parseAmount(purchase?.discount) + parseAmount(purchase?.taxAmount)).toFixed(2)), 0);
...
const buildpurchasePaymentEntry = (purchase = {}, payment = {}, purchaseIndex = 0, paymentIndex = 0)=>{
    ...
    return {
        ...
        notes: payment?.notes || "",
        transactionTimestamp: normalizedPayment.appliedAt || normalizedPayment.date || purchase?.updatedAt || purchase?.saleDate || purchase?.purchaseDate || "",
        source: "payment"
    };
};
...
const syncCachedpurchase = (nextpurchase)=>{
    if (("TURBOPACK compile-time value", "object") === "undefined" || !nextpurchase) {
        return;
    }
    try {
        ...
        const targetKeys = [
            nextpurchase?._id,
            nextpurchase?.invoiceNo,
            nextpurchase?.invoiceNumber
...
const syncCachedcustomer = (nextcustomer)=>{
    if (("TURBOPACK compile-time value", "object") === "undefined" || !nextcustomer) {
        return;
    }
    try {
        const raw = window.localStorage.getItem(CRUD_CACHE_KEY);
...
const matchescustomerpurchase = (purchase, customer)=>{
    ...
    const purchasePhone = String(purchase?.phone || purchase?.mobile || purchase?.customerPhone || purchase?.customerMobile || purchasecustomer?.phone || purchasecustomer?.mobile || "").replace(/\D/g, "").trim();
    ...
    return targetId && purchasecustomerId && String(purchasecustomerId) === String(targetId) || targetCnic && purchaseCnic && purchaseCnic === targetCnic || targetPhone && purchasePhone && purchasePhone === targetPhone || purchaseLookupKeys.some((key)=>customerLookupKeys.includes(key));
};
...
function customerDetailPage() {
    ...
    const [customerpurchases, setcustomerpurchases] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [customerPayments, setcustomerPayments] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("bills");
    const [billDateRange, setBillDateRange] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultDateRange);
    const [transactionPage, setTransactionPage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    ...
    const [blankBillDebit, setBlankBillDebit] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [blankBillDebitDraft, setBlankBillDebitDraft] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("0");
    const [blankBillPaymentId, setBlankBillPaymentId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [showBlankBillModal, setShowBlankBillModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [editTransactionTarget, setEditTransactionTarget] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isSavingEditedPayment, setIsSavingEditedPayment] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [deleteTransactionTarget, setDeleteTransactionTarget] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isDeletingTransaction, setIsDeletingTransaction] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [canDeletepurchase, setCanDeletepurchase] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const getSelectedBillPayableAmount = (bill = null)=>{
        ...
        const billPendingAmount = Math.max(Number(bill?.remainingAmountNumber || 0), Number(bill?.balance || 0), 0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "customerDetailPage.useEffect": ()=>{
            ...
            setCanDeletepurchase((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasPermission"])(permissions, "purchase_DELETE"));
        }
    }["customerDetailPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "customerDetailPage.useEffect": ()=>{
    ...
    const loadcustomerData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "customerDetailPage.useCallback[loadcustomerData]": async ({ silent = false } = {})=>{
            if (!customerId) {
                setLoading(false);
                return;
            }
            ...
            try {
                const [customerResponse, purchasesResponse, paymentsResponse] = await Promise.all([
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/sales", {
                        method: "GET",
                ...
                if (customerResponse?.success && customerResponse?.customer) {
                    ...
                    setcustomerpurchases(purchasesArray.filter({
                        "customerDetailPage.useCallback[loadcustomerData]": (purchase)=>matchescustomerpurchase(purchase, normalizedcustomer)
                    }["customerDetailPage.useCallback[loadcustomerData]"]));
                    const normalizedPayments = extractcustomerPaymentsArray(paymentsResponse).map({
                        "customerDetailPage.useCallback[loadcustomerData].normalizedPayments": (payment)=>normalizecustomerPayment(payment)
                    }["customerDetailPage.useCallback[loadcustomerData].normalizedPayments"]);
                    const remainingBillPayment = normalizedPayments.find({
                        "customerDetailPage.useCallback[loadcustomerData].remainingBillPayment": (payment)=>String(payment?.notes || "").trim() === REMAINING_BILL_MARKER
                    }["customerDetailPage.useCallback[loadcustomerData].remainingBillPayment"]);
                    ...
                    setcustomerPayments(normalizedPayments.filter({
                        "customerDetailPage.useCallback[loadcustomerData]": (payment)=>String(payment?.notes || "").trim() !== REMAINING_BILL_MARKER
                    }["customerDetailPage.useCallback[loadcustomerData]"]));
                } else {
                    setcustomer(null);
                    setBlankBillDebit(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "customerDetailPage.useEffect": ()=>{
            loadcustomerData();
            const handleFocus = {
                "customerDetailPage.useEffect.handleFocus": ()=>loadcustomerData({
                        silent: true
                    })
            }["customerDetailPage.useEffect.handleFocus"];
            const handleVisibilityChange = {
                "customerDetailPage.useEffect.handleVisibilityChange": ()=>{
            ...
            const intervalId = window.setInterval({
                "customerDetailPage.useEffect.intervalId": ()=>{
                    loadcustomerData({
                        silent: true
                    });
                }
            }["customerDetailPage.useEffect.intervalId"], 15000);
    ...
    const displayBills = (()=>{
        ...
        return customerpurchases.map((purchase, index)=>{
            ...
            return {
                ...
                reference,
                transactionTimestamp: purchase?.updatedAt || matchedStoredBill?.updatedAt || purchase?.createdAt || purchase?.saleDate || purchase?.purchaseDate || "",
                source: "bill"
            };
        });
    })();
    const totalBillAmount = displayBills.reduce((sum, bill)=>sum + bill.amountNumber, 0);
    const totalSpentAmount = Number(totalBillAmount || 0) + Number(blankBillDebit || 0);
    const totalOutstandingAmount = displayBills.reduce((sum, bill)=>sum + bill.remainingAmountNumber, 0);
    const totalcustomerPendingAmount = Math.max(Number(totalOutstandingAmount || 0) + Number(blankBillDebit || 0), 0);
    ...
    const filteredTransactions = transactionsWithBalance.filter((entry)=>{
        if (entry?.isBlankBillRow) return true;
    ...
    const latestBillBalance = Number(filteredTransactions.find((entry)=>String(entry?.type || "").toLowerCase() === "bill")?.balance || filteredTransactions?.[0]?.balance || 0);
    const latestTransactionBalance = Number(filteredTransactions?.[0]?.balance || 0);
    const shouldShowAddPaymentButton = Number(latestTransactionBalance || 0) > 0 || Number(latestBillBalance || 0) > 0;
    ...
    const purchasedProducts = customerpurchases.flatMap((purchase, purchaseIndex)=>(Array.isArray(purchase?.items) ? purchase.items : Array.isArray(purchase?.products) ? purchase.products : []).map((item, itemIndex)=>({
                id: [
    ...
    const persistcustomerLedger = async (nextBills)=>{
        ...
        let response = null;
        try {
            response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/customers/${customerId}`, {
                method: "PUT",
                data: payload
            });
        } catch (primaryError) {
            try {
                response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/customers/updatecustomer/${customerId}`, {
                    method: "PUT",
                    data: payload
                });
            } catch (fallbackError) {
    ...
    const removeMatchingcustomerLedgerPayments = (payments = [], entry, linkedpurchase = null)=>(Array.isArray(payments) ? payments : []).filter((payment)=>!iscustomerLedgerPaymentMatch(payment, entry, linkedpurchase));
    const getGroupedPaymentEntries = (entry = null)=>{
        ...
        return customerPayments.filter((payment)=>String(payment?.notes || "").trim() === batchKey);
    };
    const findLinkedpurchaseForPaymentRecord = (paymentRecord = {})=>{
        const directSaleId = String(paymentRecord?.saleId || "").trim();
        if (directSaleId) {
            const directMatch = customerpurchases.find((purchase)=>String(purchase?._id || "").trim() === directSaleId);
            if (directMatch) {
                return directMatch;
            }
        }
        return findLinkedpurchase({
            ...paymentRecord,
    ...
    const createCustomerTotalPaymentBatch = async ({ amount, paymentDate, reference, method, batchNote = `${CUSTOMER_TOTAL_PAYMENT_BATCH_PREFIX}${Date.now()}` })=>{
        ...
        for (const outstandingBill of outstandingBills){
            ...
            const paymentResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/customerpayments/createCustomerPayment", {
                method: "POST",
        ...
        if (remainingToAllocate > 0) {
            const customerRemainingBillAmount = Math.max(payableAmount - outstandingBillsTotal, 0);
            if (customerRemainingBillAmount > 0) {
                const remainingBillPaymentResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/customerpayments/createCustomerPayment", {
                    method: "POST",
                    allowOfflineCrud: false,
                    data: {
                        customerId: customer.id || customer._id,
        ...
        try {
            ...
            if (nextDebit <= 0) {
                if (existingPaymentId) {
                    const deleteResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/customerpayments/deleteCustomerPayment/${existingPaymentId}`, {
                        method: "DELETE",
                        allowOfflineCrud: false,
                        data: {
                ...
                const updateResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/customerpayments/updateCustomerPayment/${existingPaymentId}`, {
                    method: "PUT",
                    allowOfflineCrud: false,
                    data: {
                        customerId: customerIdentifier,
                ...
                const createResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/customerpayments/createCustomerPayment", {
                    method: "POST",
                    allowOfflineCrud: false,
                    data: {
                        customerId: customerIdentifier,
    ...
    const handleEditPaymentTransaction = async (event)=>{
        ...
        const maxAllowedAmount = editTransactionTarget?.isGroupedPayment ? previousAmount + Number(getCustomerPendingPayableAmount() || 0) : previousAmount + Number(editTransactionTarget.linkedBillRemaining || 0);
        ...
        try {
            if (editTransactionTarget?.isGroupedPayment) {
                ...
                for (const groupedPayment of groupedPayments){
                    ...
                    const deleteResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/customerpayments/deleteCustomerPayment/${paymentId}`, {
                        method: "DELETE",
                        allowOfflineCrud: false,
                        data: {
                            customerId: customer.id || customer._id,
            ...
            const updateResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/customerpayments/updateCustomerPayment/${paymentId}`, {
                method: "PUT",
                allowOfflineCrud: false,
                data: {
                    customerId: customer.id || customer._id,
    ...
    const handleDeleteTransaction = async (entry = deleteTransactionTarget)=>{
        ...
        if (entry.type === "bill") {
            ...
            const deleteResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/purchases/deletepurchase/${linkedpurchase._id}`, {
                method: "DELETE"
            });
            if (!deleteResponse?.success) {
        ...
        try {
            ...
            }) || customerpurchases.find((purchase, purchaseIndex)=>(Array.isArray(purchase?.paymentHistory) ? purchase.paymentHistory : []).some((payment, paymentIndex)=>isPurchasePaymentEntryMatch(purchase, payment, entry, purchaseIndex, paymentIndex)));
            const deleteResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/customerpayments/deleteCustomerPayment/${paymentId}`, {
                method: "DELETE",
                allowOfflineCrud: false,
                data: {
    ...
    const handlePrintTransactions = ()=>{
        if (("TURBOPACK compile-time value", "object") === "undefined" || !customer) return;
        const printTransactions = displayTransactions;
        const rows = printTransactions.map((entry)=>`
          <tr>
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: "Loading customer details..."
            }, void 0, false, {
                fileName: "[project]/app/AdminDashboard/customers/[id]/page.jsx",
                lineNumber: 2240,
                columnNumber: 9
            }, this)
        }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: String(customer.name || "C").charAt(0)
                                                }, void 0, false, {
                                                    fileName: "[project]/app/AdminDashboard/customers/[id]/page.jsx",
                                                    lineNumber: 2274,
                                                    columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: formatRoundedRs(totalSpentAmount)
                                            }, void 0, false, {
                                                fileName: "[project]/app/AdminDashboard/customers/[id]/page.jsx",
                                                lineNumber: 2293,
                                                columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: formatRoundedRs(latestTransactionBalance)
                                            }, void 0, false, {
                                                fileName: "[project]/app/AdminDashboard/customers/[id]/page.jsx",
                                                lineNumber: 2297,
                                                columnNumber: 15
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    shouldShowAddPaymentButton ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                        ...
                                                        children: paginatedTransactions.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                            ...
                                                            lineNumber: 2390,
                                                            columnNumber: 25
                                                        }, this) : paginatedTransactions.map((entry)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                        className: "px-2.5 py-2.5 text-sm text-gray-700 dark:text-gray-300",
                                                                        children: formatRoundedRs(entry.debit)
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/AdminDashboard/customers/[id]/page.jsx",
                                                                        lineNumber: 2416,
                                                                        columnNumber: 29
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                        className: "px-2.5 py-2.5 text-sm font-medium text-gray-900 dark:text-white",
                                                                        children: formatRoundedRs(entry.balance)
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/AdminDashboard/customers/[id]/page.jsx",
                                                                        lineNumber: 2418,
                                                                        columnNumber: 29
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                        className: "px-2.5 py-2.5 text-sm text-gray-700 dark:text-gray-300",
                                                                        children: entry.isBlankBillRow ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                            type: "button",
                                                                            ...
                                                                            lineNumber: 2421,
                                                                            columnNumber: 33
                                                                        }, this) : entry.type === "payment" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                className: "divide-y divide-gray-200 dark:divide-gray-700",
                                                children: purchasedProducts.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        colSpan: 7,
                                                        className: "px-4 py-8 text-center text-sm text-gray-500 dark:text-gray-400",
                                                        children: "No products found for this customer."
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/AdminDashboard/customers/[id]/page.jsx",
                                                        lineNumber: 2489,
                                                        columnNumber: 25
                                                    ...
                                                    lineNumber: 2488,
                                                    columnNumber: 23
                                                }, this) : purchasedProducts.map((product)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                className: "divide-y divide-gray-200 dark:divide-gray-700",
                                                children: paymentHistoryToShow.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        colSpan: 6,
                                                        className: "px-4 py-8 text-center text-sm text-gray-500 dark:text-gray-400",
                                                    ...
                                                    lineNumber: 2539,
                                                    columnNumber: 23
                                                }, this) : paymentHistoryToShow.map((payment)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                className: "px-4 py-3 text-sm font-medium text-gray-900 dark:text-white",
                                                                children: payment.id
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        className: "font-medium text-gray-900 dark:text-white",
                                                                        children: formatDate(customer.registeredDate || customer.createdAt)
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/AdminDashboard/customers/[id]/page.jsx",
                                                                        lineNumber: 2576,
                                                                        columnNumber: 173
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        className: "font-medium text-gray-900 dark:text-white",
                                                                        children: formatRs(customer.creditLimit)
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/AdminDashboard/customers/[id]/page.jsx",
                                                                        lineNumber: 2577,
                                                                        columnNumber: 172
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        className: "font-medium text-gray-900 dark:text-white",
                                                                        children: formatRs(customer.totalDue)
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/AdminDashboard/customers/[id]/page.jsx",
                                                                        lineNumber: 2578,
                                                                        columnNumber: 165
            ...
            showBlankBillModal ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            editTransactionTarget?.type === "payment" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "w-full max-w-sm rounded-2xl bg-white shadow-2xl dark:bg-gray-800",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            deleteTransactionTarget?.type === "payment" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(customerDetailPage, "tWFXjA4DnYEuSRzD+XZOjb8JdmM=", false, function() {
    return [
...
//# sourceMappingURL=app_AdminDashboard_7ea4b4bb._.js.map