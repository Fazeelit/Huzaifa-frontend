...
"[project]/app/AdminDashboard/utils/dailyCash.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/AdminDashboard/components/Dashboard/Card.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$utils$2f$dailyCash$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/AdminDashboard/utils/dailyCash.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const Cards = ()=>{
    _s();
    const { can } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$usePermissions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePermissions"])();
                ...
                "Cards.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        const [salesRes, expenseRes, productRes, purchaseRes, customersRes, suppliersRes, supplierPaymentsRes] = await Promise.allSettled([
                            canSaleView ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/sales") : Promise.resolve({
                                data: []
                            }),
                            canExpenseView ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/expenses") : Promise.resolve({
                                data: []
                            }),
                            canProductView ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/products") : Promise.resolve({
                                data: []
                            }),
                            canPurchaseView ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/purchases") : Promise.resolve({
                                data: []
                            }),
                            canCustomerView ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/customers") : Promise.resolve({
                                customers: []
                            }),
                            canSupplierView ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/suppliers") : Promise.resolve({
                                data: []
                            }),
                            canSupplierView ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/supplierpayments", {
                        ...
                        const settledValue = {
                            "Cards.useEffect.fetchData.settledValue": (result)=>result.status === "fulfilled" ? result.value : {
                                    data: []
                                }
                        }["Cards.useEffect.fetchData.settledValue"];
                        ...
                        const supplierPayments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$utils$2f$dailyCash$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSupplierPaymentsArray"])(settledValue(supplierPaymentsRes));
                        /* ================= MERGE PRODUCTS ================= */ const productMap = new Map();
                        products.forEach({
                            "Cards.useEffect.fetchData": (p)=>{
                                ...
                                getProductLookupKeys(p).forEach({
                                    "Cards.useEffect.fetchData": (key)=>{
                        ...
                        const mergedProducts = Array.from(new Map(Array.from(productMap.values()).map({
                            "Cards.useEffect.fetchData.mergedProducts": (product)=>[
                                    String(product?._id || product?.name || "").trim().toLowerCase(),
                                    product
                                ]
                        }["Cards.useEffect.fetchData.mergedProducts"])).values());
                        /* ================= TODAY FILTERS ================= */ const todaysSales = sales.filter({
                            "Cards.useEffect.fetchData.todaysSales": (s)=>isToday(s.saleDate || s.createdAt)
                        }["Cards.useEffect.fetchData.todaysSales"]);
                        /* ================= SALE PROFIT ================= */ const calculateProfit = {
                            "Cards.useEffect.fetchData.calculateProfit": (sale)=>{
                                const saleTotal = getSaleTotal(sale);
                                const totalPurchaseAmount = (Array.isArray(sale?.products) ? sale.products : []).reduce({
                                    "Cards.useEffect.fetchData.calculateProfit.totalPurchaseAmount": (sum, product)=>{
                                ...
                                }["Cards.useEffect.fetchData.calculateProfit.totalPurchaseAmount"], 0);
                                return Number((saleTotal - totalPurchaseAmount).toFixed(2));
                            }
                        }["Cards.useEffect.fetchData.calculateProfit"];
                        const calculateSalesPageProfit = {
                            "Cards.useEffect.fetchData.calculateSalesPageProfit": (sale)=>{
                                const totalPurchaseAmount = (Array.isArray(sale?.products) ? sale.products : []).reduce({
                                    "Cards.useEffect.fetchData.calculateSalesPageProfit.totalPurchaseAmount": (sum, product)=>{
                                        const quantity = Math.max(Number(product?.quantity || product?.qty || 0) - Number(product?.returnedQuantity || 0), 0);
                                        return sum + Number(product?.purchasePrice || 0) * quantity;
                                    }
                                }["Cards.useEffect.fetchData.calculateSalesPageProfit.totalPurchaseAmount"], 0);
                                return Number((Number(sale?.totalAmount || 0) - totalPurchaseAmount).toFixed(2));
                            }
                        }["Cards.useEffect.fetchData.calculateSalesPageProfit"];
                        const todayProfit = todaysSales.reduce({
                            "Cards.useEffect.fetchData.todayProfit": (sum, sale)=>sum + calculateProfit(sale)
                        }["Cards.useEffect.fetchData.todayProfit"], 0);
                        const todaySale = todaysSales.reduce({
                            "Cards.useEffect.fetchData.todaySale": (sum, sale)=>sum + getSaleTotal(sale)
                        }["Cards.useEffect.fetchData.todaySale"], 0);
                        const { dailyCash } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$utils$2f$dailyCash$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeDailyCashSnapshot"])({
                            sales,
                            expenses,
                            customers,
                            suppliers,
                        ...
                        const pendingAmount = customers.reduce({
                            "Cards.useEffect.fetchData.pendingAmount": (sum, customer)=>sum + getCustomerOutstandingAmount(customer)
                        }["Cards.useEffect.fetchData.pendingAmount"], 0);
                        /* ================= JANUARY 1 RESET CARDS ================= */ const yearToDateSales = sales.filter({
                            "Cards.useEffect.fetchData.yearToDateSales": (sale)=>isDateInRange(sale.saleDate || sale.createdAt, currentYearStart, nextYearStart)
                        }["Cards.useEffect.fetchData.yearToDateSales"]);
                        const isFirstDayOfMonth = today.getDate() === 1;
                        const currentMonthSales = sales.filter({
                            "Cards.useEffect.fetchData.currentMonthSales": (sale)=>isDateInRange(sale.saleDate || sale.createdAt, currentMonthStart, nextMonthStart)
                        }["Cards.useEffect.fetchData.currentMonthSales"]);
                        const monthlySalesAmount = isFirstDayOfMonth ? 0 : currentMonthSales.reduce({
                            "Cards.useEffect.fetchData": (sum, sale)=>sum + getSaleTotal(sale)
                        }["Cards.useEffect.fetchData"], 0);
                        const monthlyProfit = isFirstDayOfMonth ? 0 : currentMonthSales.reduce({
                            "Cards.useEffect.fetchData": (sum, sale)=>sum + calculateSalesPageProfit(sale)
                        }["Cards.useEffect.fetchData"], 0);
                        /* ================= EXPENSES ================= */ const currentMonthExpenses = expenses.filter({
                            "Cards.useEffect.fetchData.currentMonthExpenses": (expense)=>{
                                return isDateInRange(expense.date || expense.createdAt, currentMonthStart, nextMonthStart);
                            }
                        }["Cards.useEffect.fetchData.currentMonthExpenses"]);
                        const totalExpenses = isFirstDayOfMonth ? 0 : currentMonthExpenses.reduce({
                            "Cards.useEffect.fetchData": (sum, e)=>sum + getExpenseAmount(e)
                        }["Cards.useEffect.fetchData"], 0);
                        const pendingPayments = isFirstDayOfMonth ? 0 : currentMonthExpenses.filter({
                            "Cards.useEffect.fetchData": (e)=>String(e.paymentStatus || "").toLowerCase() === "pending"
                        }["Cards.useEffect.fetchData"]).reduce({
                            "Cards.useEffect.fetchData": (sum, e)=>sum + getExpenseAmount(e)
                        }["Cards.useEffect.fetchData"], 0);
                        const completedPayments = isFirstDayOfMonth ? 0 : currentMonthExpenses.filter({
                            "Cards.useEffect.fetchData": (e)=>[
                                    "completed",
                                    "paid"
                                ].includes(String(e.paymentStatus || "").toLowerCase())
                        }["Cards.useEffect.fetchData"]).reduce({
                            "Cards.useEffect.fetchData": (sum, e)=>sum + getExpenseAmount(e)
                        }["Cards.useEffect.fetchData"], 0);
                        /* ================= OTHER METRICS ================= */ const lowStockItems = mergedProducts.filter({
                            "Cards.useEffect.fetchData": (p)=>p.stock < 5
                        }["Cards.useEffect.fetchData"]).length;
                        const currentMonthPurchases = purchases.filter({
                            "Cards.useEffect.fetchData.currentMonthPurchases": (purchase)=>{
                                return isDateInRange(purchase.purchaseDate || purchase.date || purchase.createdAt, currentMonthStart, nextMonthStart);
                            }
                        }["Cards.useEffect.fetchData.currentMonthPurchases"]);
                        const totalProductPurchase = isFirstDayOfMonth ? 0 : currentMonthPurchases.reduce({
                            "Cards.useEffect.fetchData": (sum, p)=>sum + getPurchaseAmount(p)
                        }["Cards.useEffect.fetchData"], 0);
...
_s(Cards, "2Fk/qBCR0VGTfX28s3Gkh+eyKf0=", false, function() {
    return [
...
"[project]/app/AdminDashboard/authservice/labApi.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const listLabOrders = async (options = {})=>{
    try {
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/tests", options);
        return asList(res);
    } catch (error) {
...
const getLabOrderById = async (id, options = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/tests/${id}`, options);
const createLabOrder = async (payload, options = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/tests/createTest", {
        method: "POST",
        data: payload,
        ...options
    });
const updateLabOrder = async (id, payload, options = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/tests/updateTest/${id}`, {
        method: "PUT",
        data: payload,
        ...options
    });
const deleteLabOrder = async (id, options = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/tests/deleteTest/${id}`, {
        method: "DELETE",
        ...options
    });
const listLabTemplates = async (options = {})=>{
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/testParameters", options);
    return asList(res);
};
const createLabTemplate = async (payload, options = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/testParameters/createTestparameter", {
        method: "POST",
        data: payload,
        ...options
    });
const updateLabTemplate = async (id, payload, options = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/testParameters/updateTestparameter/${id}`, {
        method: "PUT",
        data: payload,
        ...options
    });
const deleteLabTemplate = async (id, options = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/testParameters/deleteTestparameter/${id}`, {
        method: "DELETE",
        ...options
    });
const listLabCategories = async (options = {})=>{
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/lab-categories", options);
    return asList(res);
};
const createLabCategory = async (payload, options = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/lab-categories/create", {
        method: "POST",
        data: payload,
        ...options
    });
const updateLabCategory = async (id, payload, options = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/lab-categories/update/${id}`, {
        method: "PUT",
        data: payload,
        ...options
    });
const deleteLabCategory = async (id, options = {})=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/lab-categories/delete/${id}`, {
        method: "DELETE",
        ...options
    });
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/app/AdminDashboard/components/Dashboard/RevenueTrend.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/AdminDashboard/authservice/api.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$usePermissions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/AdminDashboard/authservice/usePermissions.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$labApi$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/AdminDashboard/authservice/labApi.js [app-client] (ecmascript)");
...
const RevenueTrend = ()=>{
    ...
    const chartHostRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const [chartSize, setChartSize] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        width: 0,
        height: 300
    });
    const { can } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$usePermissions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePermissions"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RevenueTrend.useEffect": ()=>{
            const fetchRevenue = {
                "RevenueTrend.useEffect.fetchRevenue": async ()=>{
                    try {
                        const canSaleView = can("SALE_VIEW");
                        const canTestView = can("TEST_VIEW");
                        const safeFetch = {
                            "RevenueTrend.useEffect.fetchRevenue.safeFetch": async (endpoint, allowed)=>{
                                if (!allowed) return {
                                    data: []
                                };
                                try {
                                    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(endpoint, {
                                        suppressErrorToast: true,
                                        suppressErrorLog: true
                                    });
                                } catch  {
                        ...
                        }["RevenueTrend.useEffect.fetchRevenue.safeFetch"];
                        const [salesRes, testsRes] = await Promise.all([
                            safeFetch("/sales", canSaleView),
                            canTestView ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$labApi$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listLabOrders"])({
                                suppressErrorToast: true,
                                suppressErrorLog: true
                            }) : Promise.resolve([])
                        ]);
                        ...
                        const last7Days = Array.from({
                            ...
                            "RevenueTrend.useEffect.fetchRevenue.last7Days": (_, i)=>{
                                const d = new Date();
                                d.setDate(today.getDate() - (6 - i)); // oldest first
                                d.setHours(0, 0, 0, 0);
                                return d;
                            }
                        }["RevenueTrend.useEffect.fetchRevenue.last7Days"]);
                        const revenueData = last7Days.map({
                            "RevenueTrend.useEffect.fetchRevenue.revenueData": (day)=>{
                                const dayStr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$utils$2f$formatting$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDateDDMMYYYY"])(day);
                                // Calculate revenue for the day
                                const dayRevenue = sales.filter({
                                    "RevenueTrend.useEffect.fetchRevenue.revenueData": (s)=>new Date(s.createdAt).toDateString() === day.toDateString()
                                }["RevenueTrend.useEffect.fetchRevenue.revenueData"]).reduce({
                                    "RevenueTrend.useEffect.fetchRevenue.revenueData": (sum, s)=>sum + Number(s.profit || 0)
                                }["RevenueTrend.useEffect.fetchRevenue.revenueData"], 0) + tests.filter({
                                    "RevenueTrend.useEffect.fetchRevenue.revenueData": (t)=>new Date(t.createdAt).toDateString() === day.toDateString()
                                }["RevenueTrend.useEffect.fetchRevenue.revenueData"]).reduce({
                                    "RevenueTrend.useEffect.fetchRevenue.revenueData": (sum, t)=>sum + Number(t.totalfee || 0)
                                }["RevenueTrend.useEffect.fetchRevenue.revenueData"], 0);
                                return {
                                    date: dayStr,
                                    revenue: dayRevenue
                                };
                            }
                        }["RevenueTrend.useEffect.fetchRevenue.revenueData"]);
                        setData(revenueData);
                    } catch (error) {
                        setData([]);
                    }
                }
            }["RevenueTrend.useEffect.fetchRevenue"];
            fetchRevenue();
        }
    }["RevenueTrend.useEffect"], [
        can
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RevenueTrend.useEffect": ()=>{
            ...
            const updateChartReady = {
                "RevenueTrend.useEffect.updateChartReady": ()=>{
            ...
            return ({
                "RevenueTrend.useEffect": ()=>observer.disconnect()
            })["RevenueTrend.useEffect"];
        }
    }["RevenueTrend.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(RevenueTrend, "zf2BHvTZ1TR6HfgM5lZVrjUW5Vs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$usePermissions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePermissions"]
    ];
});
...
"[project]/app/AdminDashboard/components/Dashboard/LowStockAlert.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const LowStockAlert = ()=>{
    ...
    /* =========================
     Fetch products
  ========================= */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LowStockAlert.useEffect": ()=>{
            const fetchProducts = {
                "LowStockAlert.useEffect.fetchProducts": async ()=>{
                    try {
            ...
            }["LowStockAlert.useEffect.fetchProducts"];
            fetchProducts();
        }
    }["LowStockAlert.useEffect"], []);
    /* =========================
  ...
  ========================= */ const lowStockItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LowStockAlert.useMemo[lowStockItems]": ()=>{
            if (!Array.isArray(products) || products.length === 0) return [];
            const map = new Map();
            products.forEach({
                "LowStockAlert.useMemo[lowStockItems]": (p)=>{
            ...
            return Array.from(map.values()).filter({
                "LowStockAlert.useMemo[lowStockItems]": (p)=>p.stock <= LOW_STOCK_LIMIT
            }["LowStockAlert.useMemo[lowStockItems]"]).map({
                "LowStockAlert.useMemo[lowStockItems]": (p)=>({
                        name: p.name,
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: lowStockItems.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(LowStockAlert, "rz9khVMQeWXmU/3EqqvwgxmogQ8=");
_c = LowStockAlert;
...
//# sourceMappingURL=app_AdminDashboard_7af9a317._.js.map