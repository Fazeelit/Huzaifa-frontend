...
"[project]/app/AdminDashboard/components/pages/OutdoorSupplyReportPage.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const buildReportRows = ({ outdoorSupplies, outdoorSuppliers, products, sales, startDate, endDate })=>{
    ...
    const dailyRows = filteredSupplies.map((supply, index)=>{
        ...
        const row = {
            ...
            dateKey,
            dateLabel: supplyDate ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$utils$2f$formatting$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDateDDMMYYYY"])(supplyDate) : "-",
...
function OutdoorSupplyReportPage() {
    ...
    const [startDate, setStartDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(formatDateInput(defaultStart));
    const [endDate, setEndDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(formatDateInput(defaultEnd));
    const [outdoorSupplies, setOutdoorSupplies] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [outdoorSuppliers, setOutdoorSuppliers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OutdoorSupplyReportPage.useEffect": ()=>{
            const fetchOutdoorData = {
                "OutdoorSupplyReportPage.useEffect.fetchOutdoorData": async ()=>{
                    try {
            ...
            }["OutdoorSupplyReportPage.useEffect.fetchOutdoorData"];
            const fetchSales = {
                "OutdoorSupplyReportPage.useEffect.fetchSales": async ()=>{
                    try {
            ...
            }["OutdoorSupplyReportPage.useEffect.fetchSales"];
            const fetchProducts = {
                "OutdoorSupplyReportPage.useEffect.fetchProducts": async ()=>{
                    ...
                    const canProductView = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$permissions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasPermission"])("PRODUCT_VIEW", permissions);
                    if (!canProductView) {
                        setProducts([]);
                        return;
                    }
                    try {
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/products", {
                            method: "GET",
                            suppressErrorToast: true
                        });
            ...
            }["OutdoorSupplyReportPage.useEffect.fetchProducts"];
            const load = {
                "OutdoorSupplyReportPage.useEffect.load": async ()=>{
                    setLoading(true);
                    await Promise.all([
                        fetchOutdoorData(),
                        fetchProducts(),
            ...
            }["OutdoorSupplyReportPage.useEffect.load"];
            load();
        }
    }["OutdoorSupplyReportPage.useEffect"], []);
    const pageReportData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OutdoorSupplyReportPage.useMemo[pageReportData]": ()=>buildReportRows({
                outdoorSupplies,
                outdoorSuppliers,
                products,
                sales
            })
    }["OutdoorSupplyReportPage.useMemo[pageReportData]"], [
        outdoorSupplies,
        outdoorSuppliers,
        products,
        sales
    ]);
    const exportReportData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OutdoorSupplyReportPage.useMemo[exportReportData]": ()=>buildReportRows({
                outdoorSupplies,
                outdoorSuppliers,
                products,
                sales,
    ...
    }["OutdoorSupplyReportPage.useMemo[exportReportData]"], [
        endDate,
        outdoorSupplies,
        outdoorSuppliers,
        products,
    ...
    const handleExportPdf = ()=>{
        ...
        const doc = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jspdf$2f$dist$2f$jspdf$2e$es$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsPDF"]("l", "mm", "a4");
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    pageReportData.dailyRows.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    ...
                                    children: pageReportData.dailyRows.map((row)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            className: "align-top",
                                            children: [
...
_s(OutdoorSupplyReportPage, "QtM+4gt17s1Aj9FyoQqD3DxbCAM=");
_c = OutdoorSupplyReportPage;
var _c;
__turbopack_context__.k.register(_c, "OutdoorSupplyReportPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/AdminDashboard/outdoor-supply-report/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$components$2f$pages$2f$OutdoorSupplyReportPage$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/AdminDashboard/components/pages/OutdoorSupplyReportPage.jsx [app-client] (ecmascript)");
"use client";
;
;
function OutdoorSupplyReportRoute() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$components$2f$pages$2f$OutdoorSupplyReportPage$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
        fileName: "[project]/app/AdminDashboard/outdoor-supply-report/page.jsx",
        lineNumber: 6,
        columnNumber: 10
    }, this);
}
_c = OutdoorSupplyReportRoute;
var _c;
__turbopack_context__.k.register(_c, "OutdoorSupplyReportRoute");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=app_AdminDashboard_d10ea05f._.js.map