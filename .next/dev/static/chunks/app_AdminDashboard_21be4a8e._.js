...
"[project]/app/AdminDashboard/suppliers/[id]/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const syncCachedSupplier = (nextSupplier)=>{
    if (("TURBOPACK compile-time value", "object") === "undefined" || !nextSupplier) {
        return;
    }
    try {
        const raw = window.localStorage.getItem(CRUD_CACHE_KEY);
...
function supplierDetailPage() {
    ...
    const [supplierpurchases, setsupplierpurchases] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const loadsupplierData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "supplierDetailPage.useCallback[loadsupplierData]": async ({ silent = false } = {})=>{
            if (!supplierId) {
                setLoading(false);
                return;
            }
            ...
            try {
                const [supplierResponse, purchasesResponse, paymentsResponse] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/suppliers/${supplierId}`, {
                        method: "GET",
                        suppressErrorToast: silent
                    }),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/purchases", {
                        method: "GET",
                        suppressErrorToast: true,
                        suppressErrorLog: true
                    }),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/supplierpayments/getSupplierPaymentsBySupplier/${supplierId}`, {
                        method: "GET",
                        suppressErrorToast: true,
                        suppressErrorLog: true
                    })
                ...
                if (supplierResponse?.success && supplierResponse?.supplier) {
                    ...
                    setsupplierpurchases(purchasesArray.filter({
                        "supplierDetailPage.useCallback[loadsupplierData]": (purchase)=>matchessupplierpurchase(purchase, normalizedsupplier)
                    }["supplierDetailPage.useCallback[loadsupplierData]"]));
                    const normalizedPayments = extractSupplierPaymentsArray(paymentsResponse).map({
                        "supplierDetailPage.useCallback[loadsupplierData].normalizedPayments": (payment)=>normalizeSupplierPayment(payment)
                    }["supplierDetailPage.useCallback[loadsupplierData].normalizedPayments"]);
                    const remainingBillPayment = normalizedPayments.find({
                        "supplierDetailPage.useCallback[loadsupplierData].remainingBillPayment": (payment)=>String(payment?.notes || "").trim() === REMAINING_BILL_MARKER
                    }["supplierDetailPage.useCallback[loadsupplierData].remainingBillPayment"]);
                    ...
                    setSupplierPayments(normalizedPayments.filter({
                        "supplierDetailPage.useCallback[loadsupplierData]": (payment)=>String(payment?.notes || "").trim() !== REMAINING_BILL_MARKER
                    }["supplierDetailPage.useCallback[loadsupplierData]"]));
                } else {
                    setsupplier(null);
                    setBlankBillDebit(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "supplierDetailPage.useEffect": ()=>{
            loadsupplierData();
            const handleFocus = {
                "supplierDetailPage.useEffect.handleFocus": ()=>loadsupplierData({
                        silent: true
                    })
            }["supplierDetailPage.useEffect.handleFocus"];
            const handleVisibilityChange = {
                "supplierDetailPage.useEffect.handleVisibilityChange": ()=>{
            ...
            const intervalId = window.setInterval({
                "supplierDetailPage.useEffect.intervalId": ()=>{
                    loadsupplierData({
                        silent: true
                    });
                }
            }["supplierDetailPage.useEffect.intervalId"], 15000);
    ...
    const persistsupplierLedger = async (nextBills)=>{
        ...
        let response = null;
        try {
            response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/suppliers/${supplierId}`, {
                method: "PUT",
                data: payload
            });
        } catch (primaryError) {
            try {
                response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/suppliers/updateSupplier/${supplierId}`, {
                    method: "PUT",
                    data: payload
                });
            } catch (fallbackError) {
        ...
        try {
            ...
            if (nextDebit <= 0) {
                if (existingPaymentId) {
                    const deleteResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/supplierpayments/deleteSupplierPayment/${existingPaymentId}`, {
                        method: "DELETE",
                ...
                const updateResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/supplierpayments/updateSupplierPayment/${existingPaymentId}`, {
                    method: "PUT",
                    allowOfflineCrud: false,
                    data: {
                        supplierId: supplierIdentifier,
                ...
                const createResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/supplierpayments/createSupplierPayment", {
                    method: "POST",
                    allowOfflineCrud: false,
                    data: {
                        supplierId: supplierIdentifier,
    ...
    const handleEditPaymentTransaction = async (event)=>{
        ...
        try {
            ...
            const updateResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/supplierpayments/updateSupplierPayment/${paymentId}`, {
                method: "PUT",
                allowOfflineCrud: false,
                data: {
    ...
    const handleDeleteTransaction = async (entry = deleteTransactionTarget)=>{
        ...
        try {
            ...
            const deleteResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/supplierpayments/deleteSupplierPayment/${paymentId}`, {
                method: "DELETE",
                allowOfflineCrud: false,
                data: {
                    supplierId: supplier.id || supplier._id,
        ...
        if (selectedBill?.source === "supplier-total") {
            ...
            try {
                for (const outstandingBill of outstandingBills){
                    ...
                    const paymentResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/supplierpayments/createSupplierPayment", {
                        method: "POST",
                        allowOfflineCrud: false,
                        data: {
                            supplierId: supplier.id || supplier._id,
                ...
                if (remainingToAllocate > 0) {
                    ...
                    const remainingBillPaymentResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/supplierpayments/createSupplierPayment", {
                        method: "POST",
                        allowOfflineCrud: false,
                        data: {
                            supplierId: supplier.id || supplier._id,
    ...
    const handlePrintTransactions = ()=>{
        if (("TURBOPACK compile-time value", "object") === "undefined" || !supplier) return;
...
_s(supplierDetailPage, "ZwK/QbK20oPODQubk5H5vMmTyGI=", false, function() {
    return [
...
//# sourceMappingURL=app_AdminDashboard_21be4a8e._.js.map