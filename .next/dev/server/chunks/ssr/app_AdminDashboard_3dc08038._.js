...
"[project]/app/AdminDashboard/customers/[id]/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function customerDetailPage() {
    ...
    const [customerpurchases, setcustomerpurchases] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const [customerPayments, setcustomerPayments] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const loadcustomerData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ({ silent = false } = {})=>{
        if (!customerId) {
            setLoading(false);
            return;
        }
        ...
        try {
            ...
            if (customerResponse?.success && customerResponse?.customer) {
                ...
                const normalizedPayments = extractcustomerPaymentsArray(paymentsResponse).map((payment)=>normalizecustomerPayment(payment));
                ...
                setcustomerPayments(normalizedPayments.filter((payment)=>String(payment?.notes || "").trim() !== REMAINING_BILL_MARKER));
            } else {
                setcustomer(null);
                setBlankBillDebit(0);
    ...
    const persistcustomerLedger = async (nextBills)=>{
        ...
        let response = null;
        try {
            response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/customers/${customerId}`, {
                method: "PUT",
                data: payload
            });
        } catch (primaryError) {
            try {
                response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/customers/updatecustomer/${customerId}`, {
                    method: "PUT",
                    data: payload
                });
            } catch (fallbackError) {
    ...
    const createCustomerTotalPaymentBatch = async ({ amount, paymentDate, reference, method, batchNote = `${CUSTOMER_TOTAL_PAYMENT_BATCH_PREFIX}${Date.now()}` })=>{
        ...
        for (const outstandingBill of outstandingBills){
            ...
            const paymentResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/customerpayments/createCustomerPayment", {
                method: "POST",
        ...
        if (remainingToAllocate > 0) {
            ...
            if (customerRemainingBillAmount > 0) {
                const remainingBillPaymentResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/customerpayments/createCustomerPayment", {
                    method: "POST",
                    allowOfflineCrud: false,
                    data: {
                        customerId: customer.id || customer._id,
        ...
        try {
            ...
            if (nextDebit <= 0) {
                if (existingPaymentId) {
                    const deleteResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/customerpayments/deleteCustomerPayment/${existingPaymentId}`, {
                        method: "DELETE",
                        allowOfflineCrud: false,
                        data: {
                ...
                const updateResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/customerpayments/updateCustomerPayment/${existingPaymentId}`, {
                    method: "PUT",
                    allowOfflineCrud: false,
                    data: {
                        customerId: customerIdentifier,
                ...
                const createResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/customerpayments/createCustomerPayment", {
                    method: "POST",
                    allowOfflineCrud: false,
                    data: {
                        customerId: customerIdentifier,
        ...
        try {
            if (editTransactionTarget?.isGroupedPayment) {
                ...
                for (const groupedPayment of groupedPayments){
                    ...
                    const deleteResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/customerpayments/deleteCustomerPayment/${paymentId}`, {
                        method: "DELETE",
                        allowOfflineCrud: false,
                        data: {
                            customerId: customer.id || customer._id,
            ...
            const updateResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$AdminDashboard$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])(`/customerpayments/updateCustomerPayment/${paymentId}`, {
                method: "PUT",
                allowOfflineCrud: false,
                data: {
                    customerId: customer.id || customer._id,
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    shouldShowAddPaymentButton ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
//# sourceMappingURL=app_AdminDashboard_3dc08038._.js.map